/**
  ...
  */
  ...
  #define   BUS_RF24_POLL_TIMEOUT  100
  
  /** 口线操作函数定义 */
  #define RF24L01_SET_CE_HIGH( )			HAL_GPIO_WritePin(RF24_SDN_out_GPIO_Port, RF24_SDN_out_Pin, GPIO_PIN_SET)
  #define RF24L01_SET_CE_LOW( )			HAL_GPIO_WritePin(RF24_SDN_out_GPIO_Port, RF24_SDN_out_Pin, GPIO_PIN_RESET)
  
  #define RF24L01_SET_CS_HIGH( )			HAL_GPIO_WritePin(RF24_SP6_CS_out_GPIO_Port, RF24_SP6_CS_out_Pin, GPIO_PIN_SET)
  #define RF24L01_SET_CS_LOW( )			HAL_GPIO_WritePin(RF24_SP6_CS_out_GPIO_Port, RF24_SP6_CS_out_Pin, GPIO_PIN_RESET)
  ...
  unsigned  int app_RF24_key_scan(unsigned short int timeMs);
