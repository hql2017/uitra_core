...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA4     ------> ADC1_INP18
    */
    GPIO_InitStruct.Pin = AD_OCP_CHANNEL_Pin|AD_VBUS_24V_CHANNEL_Pin|NTC_14_CHANNEL_Pin|AD_LASER_1064_CHANNEL_Pin
                          |AD_AIR_PRESSURE_CHANNEL_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA4     ------> ADC1_INP18
    */
    HAL_GPIO_DeInit(GPIOA, AD_OCP_CHANNEL_Pin|AD_VBUS_24V_CHANNEL_Pin|NTC_14_CHANNEL_Pin|AD_LASER_1064_CHANNEL_Pin
                          |AD_AIR_PRESSURE_CHANNEL_Pin);
...
{  
  ...
  else  if(adChannel==AD1_LASER_1064_INDEX)
  {
    temp=(((advalue[AD1_LASER_1064_INDEX]*AD_VREF_VOLTAGE)>>16))/10;
