...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : COOL_WATER_DEPTH_in_Pin KEY_PWR_SWITCH_Pin */
  GPIO_InitStruct.Pin = COOL_WATER_DEPTH_in_Pin|KEY_PWR_SWITCH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : PWR_SYS_ON_Pin MCU_SYS_health_LED_Pin RF24_SP6_CS_out_Pin HV_ONE_PULSE_out_Pin
                           EEROM_W_EN_out_Pin S31FL3193_SDB_out_Pin */
  GPIO_InitStruct.Pin = PWR_SYS_ON_Pin|MCU_SYS_health_LED_Pin|RF24_SP6_CS_out_Pin|HV_ONE_PULSE_out_Pin
                          |EEROM_W_EN_out_Pin|S31FL3193_SDB_out_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : FAN1_COUNT_in_Pin AIR_PUMP_COUNT_in_Pin */
  GPIO_InitStruct.Pin = FAN1_COUNT_in_Pin|AIR_PUMP_COUNT_in_Pin;
  ...
  /*Configure GPIO pins : TREATMENT_WATER_DEPTH_in_Pin water_cycle_ok_Pin REMOTE_ON_OFF_in_Pin ADS1118_DRDY_in_Pin */
  GPIO_InitStruct.Pin = TREATMENT_WATER_DEPTH_in_Pin|water_cycle_ok_Pin|REMOTE_ON_OFF_in_Pin|ADS1118_DRDY_in_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : DAC_LD_Pin DAC_CS_Pin circulating_water_pump_EN_Pin */
  GPIO_InitStruct.Pin = DAC_LD_Pin|DAC_CS_Pin|circulating_water_pump_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
