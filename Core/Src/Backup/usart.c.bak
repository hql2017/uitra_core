...
void MX_LPUART1_UART_Init(void)
{
  ...
  HAL_UART_Receive_IT(&hlpuart1,lpuart1_rx_data,1);
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PA10     ------> LPUART1_RX
    */
    GPIO_InitStruct.Pin = TMC_TCD_LPUART1_TX_Pin|TMC_TCD_LPUART1_RX_Pin;
  ...
  */
    ...
    PB13     ------> UART5_TX
    */
    GPIO_InitStruct.Pin = compressor_UART5_RX_Pin|compressor_UART5_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PA10     ------> LPUART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, TMC_TCD_LPUART1_TX_Pin|TMC_TCD_LPUART1_RX_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB13     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, compressor_UART5_RX_Pin|compressor_UART5_TX_Pin);
...
PUTCHAR_PROTOTYPE
{
	if (HAL_UART_Transmit(&hlpuart1, (uint8_t *)&ch, 1,100)!=HAL_OK)// 0xFFFF) != HAL_OK)	
  {
   // Error_Handler();    
  }
	return ch;
