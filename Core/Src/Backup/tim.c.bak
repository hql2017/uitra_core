...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = HV_ONE_PULSE_out_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(HV_ONE_PULSE_out_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PB1     ------> TIM8_CH3N
    */
    GPIO_InitStruct.Pin = FAN1_TIM8CH2N_PWM_Pin|FAN2_TIM8CH3N_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
* @brief 风扇PWM
  ...
  * @retval  
  *****************************************************************************/
 void app_fan_pwm_set(unsigned char duty,unsigned char fanNum)
 { 	
  if(duty!=0)
  {    
		unsigned int timeUs;
  ...
  {     
    if(fanNum==1) HAL_TIMEx_PWMN_Stop(&htim8,TIM_CHANNEL_2);
    else //if(fanNum==2)
    {
